 ...
 * browser selection into its own model in that time (slate-react on `selectionchange`).
 */
export const EDIT_SETTLE_SCRIPT = "new Promise(r => { setTimeout(r, 50); requestAnimationFrame(() => requestAnimationFrame(() => setTimeout(r, 0))); })";
