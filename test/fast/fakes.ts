...
import type { Action, ActionKind, Chrome, Observation, Page, Popup } from "../../src/fast/model.js";
...
export interface ActCall { op: "act" | "press" | "back" | "navigate" | "commit"; id?: string; kind?: string; text?: string; key?: string; url?: string }
