...
import { BLOCKED_VALUE_GEN, GENERATE, MODES, MODE_Q, NONE_VALUE, RULES, TARGET_RULES, TYPE_TEXT_GEN, TYPE_TEXT_HELD, TYPE_TEXT_HELD_GEN, VALUE_Q, VALUE_Q_GEN, VALUE_Q_NEW, VALUE_Q_NEW_GEN, actionSpace, answerLines, buildStep, buildValueStep, cutText, fieldLines, readEdit, readStep, readValue, rulesFor } from "../../src/fast/policy.js";
